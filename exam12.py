...
print(string_a) #10: 문자열
print(type(string_a)) #str타입

format_a="{}만원".format(5000)
format_b="파이썬 열공하여 첫 연봉 {}만원 만들기".format(5000)
format_c="{} {} {}".format(3000,4000,5000)
format_d="{} {} {}".format(1,"문자열",True) #괄호와 인수 개수 일치해야 함
...
output_l="{:15.3f}".format(52.273) #소수점 아래 자리수 지정
...
output_o=52.0
output_b="{:g}".format(output_o) #의미없는 소수점 제거
print(output_o)
print(output_b)